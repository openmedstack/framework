...
namespace OpenMedStack.NEventStore.Persistence.InMemory
{
    ...
    public class InMemoryPersistenceEngine : IPersistStreams
    {
        ...
        {
            get { return _buckets.GetOrAdd(bucketId ?? NEventStore.Bucket.Default, _ => new Bucket()); }
        }
        ...
        public IAsyncEnumerable<IStreamHead> GetStreamsToSnapshot(string bucketId, int maxThreshold, CancellationToken cancellationToken)
        {
            ThrowWhenDisposed();
