namespace OpenMedStack.NEventStore.Persistence.Sql.SqlDialects
{
    ...
    public class FirebirdSqlDialect : CommonSqlDialect
    {
        ...
        public override string GetCommitsFromBucketAndCheckpoint => FirebirdSqlStatements.GetCommitsFromBucketAndCheckpoint;
        ...
        /// <inheritdoc />
        public override IDbStatement BuildStatement(IDbConnection connection) => new FirebirdSqlStatement(this, connection);
    }
}